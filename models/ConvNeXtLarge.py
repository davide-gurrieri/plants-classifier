...
class ConvNeXtLarge(GeneralModel):
    ...
    def build(self):
        ...
        # Build the ResNet50
        ConvNeXtLarge_layer = tfk.applications.ConvNeXtLarge(
            include_top=False,
        ...
        ConvNeXtLarge_layer.trainable = False

        x = ConvNeXtLarge_layer(augmentation_layer)
